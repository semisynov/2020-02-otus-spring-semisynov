    ...
    public Step authorMigrationStep(MongoItemReader<Author> authorReader, ItemWriter<Author> authorWriter) {
        return stepBuilderFactory.get("authorMigrationStep")
                ...
                .listener(new ItemReadListener<>() {
                    ...
                    public void afterRead(@Nullable Author o) {
                ...
                .listener(new ItemProcessListener<Author, Author>() {
                    public void beforeProcess(@Nullable Author o) {
                        log.info("Начало обработки");
                    }

                    public void afterProcess(@Nullable Author o, @Nullable Author o2) {
                        log.info("Конец обработки");
                    }

                    public void onProcessError(@Nullable Author o, @Nullable Exception e) {

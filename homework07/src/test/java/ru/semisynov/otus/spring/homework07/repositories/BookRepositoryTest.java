...
class BookRepositoryTest {
    ...
    void shouldReturnExpectedBookEntryById() {
        Optional<BookEntry> optionalBookEntry = bookRepository.findBookById(FIRST_ID);
        Book expectedBook = entityManager.find(Book.class, FIRST_ID);

        assertThat(optionalBookEntry).isPresent().get().matches(b -> b.getTitle().equals(expectedBook.getTitle()));
    }

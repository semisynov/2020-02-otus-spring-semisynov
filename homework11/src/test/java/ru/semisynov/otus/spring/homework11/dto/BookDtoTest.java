...
class BookDtoTest {
    ...
    private static final List<Author> EXPECTED_AUTHORS = Collections.singletonList(new Author("12345", "Test"));
    private static final List<AuthorDto> EXPECTED_AUTHORS_DTO = Collections.singletonList(new AuthorDto("12345", "Test"));
    private static final List<Genre> EXPECTED_GENRES = Collections.singletonList(new Genre("12345", "Test"));
    private static final List<GenreDto> EXPECTED_GENRES_DTO = Collections.singletonList(new GenreDto("12345", "Test"));

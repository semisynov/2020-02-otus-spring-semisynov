...
class BookServiceImplTest {
    ...
    static class TestConfig {
        ...
        @Bean
        public BookService bookService(BookRepository bookRepository, AuthorRepository authorRepository, GenreRepository genreRepository, CommentRepository commentRepository) {
    ...
    private static final List<Author> AUTHORS = List.of(new Author("12345", "Author"));
    private static final List<Genre> GENRES = List.of(new Genre("12345", "Genre"));

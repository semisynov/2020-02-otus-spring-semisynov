...
import ru.semisynov.otus.spring.homework12.services.UserService;
...
@WebMvcTest({UserController.class, SecurityConfiguration.class, SecurityUserDetailsService.class, ApplicationConfig.class})
